  ...
  return (
    <main className="about-us-page">
      ...
      <section className="banner relative flex items-center justify-center w-full max-h-screen h-[250px] sm:h-[200px] lg:h-[520px] xl:h-[700px] 2xl:h-screen overflow-hidden bg-[url('/images/aboutus-banner.jpg')] bg-cover bg-center">
        <div className="bg-[#a7a1a1] 2xl:mb-4 bg-opacity-20 maxw 2xl:w-[53%] w-[50%] xl:w-[70%] sm:w-[90%] sm:mb-4 absolute z-[3] bottom-14 sm:bottom-5  flex items-center justify-around flex-wrap text-white p-2 sm:p-0 ">
        ...
        <div className="info 2xl:mt-[-60px] xl:mt-[100px] maxw absolute z-[2] w-full h-full flex flex-col items-center justify-center my-auto ">
          <h2 className="text-white text-center leading-[100%] font-normal mb-0 xl:mb-1 text-[10px] md:text-[10px] lg:text-[20px] xl:text-[28px] 2xl:text-[31px] sm:mb-2 sm:mx-5">
            Our values and behaviors are fueled by our purpose in life as
      ...
      <div className="m-2">
        ...
        <section id="who-we-are" className="div_section ">
          <div className="maxw flex items-center gap-4 ">
            <div className="content w-[59%] 2xl:ml-[9px]">
              <h2 className="text-black mb-5 2xl:mb-3 text-[16px] lg:text-[28px] xl:text-[36px] 2xl:text-[45px] font-normal">
                Who we are
              </h2>
              <p className="mb-0 xl:mb-[14px] 2xl:mb-[14px] leading-tight sm:leading-4 xl:leading-[24px] 2xl:leading-[27px]  text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[24px] xl:w-[90%]">
                Morsi M Partners <strong> (“MMP”) </strong> was launched in 2023
                with a clear purpose to build trust and promote collaborations
                where people and societies can sustainably advance, create, and
                be remembered for their legacies.
              </p>
              <p className="mb-0 xl:mb-[14px] 2xl:mb-[14px] leading-tight sm:leading-4 xl:leading-[24px] 2xl:leading-[27px]  text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[24px] xl:w-[90%]">
                Capitalizing on the amalgamation of knowledge and advisory
                expertise gained over the years across diverse environments,
                sectors, and geographies, we offer our clients an unrivaled
                level of service excellence to help them streamline their
                business operations, bolster their governance models in a
                rapidly evolving regulatory landscape, and offer strategic and
                tactical advice on complex challenges.
              </p>
              <p className="mb-0 xl:mb-[14px] 2xl:mb-[14px] leading-tight sm:leading-4 xl:leading-[24px] 2xl:leading-[27px]  text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[24px] xl:w-[90%]">
                As a team, we are well-embedded in the markets that we serve,
                and we have a strong global network.
              </p>
              <p className="mb-0 xl:mb-[14px] 2xl:mb-[14px] leading-tight sm:leading-4 xl:leading-[24px] 2xl:leading-[27px]  text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[24px] xl:w-[90%]">
              ...
              <div className="actions mt-[50px] sm:mt-2">
                <CustomDialog
                  ...
                  trigger={
                    <CustomButton
                      variant={"golden"}
                      className=" ml-2 2xl:ml-0 sm:ml-0 sm:mt-2 md:mt-2 lg:mt-2 2xl:mt-4"
                    >
            ...
            <div className="image w-[40%] sm:flex sm:items-center sm:justify-center xl:flex xl:items-center xl:justify-center 2xl:flex 2xl:items-center 2xl:justify-center">
              <img
                ...
                className="hidden md:block lg:block xl:block 2xl:block xl:[315px] xl:h-[404px] 2xl:w-[413px] 2xl:h-[529px] 2xl:mb-14"
              />
              <img
                alt="Get to know us image"
        ...
        <section id="our-mantra" className="div_section bggolden ">
          <div className="maxw flex items-center gap-4  2xl:pb-14 2xl:pt-10 ">
            <div className="image w-[40%] flex items-center justify-center ">
              <img
                alt="Our Mantra image"
                src={"/images/aboutus-ourmantra.jpg"}
                className="hidden md:block lg:block xl:block 2xl:block xl:[321px] xl:h-[411px] 2xl:w-[413px] 2xl:h-[529px] 2xl:ml-3"
              />
              <img
                alt="Our Mantra image"
            ...
            <div className="content w-[60%] 2xl:ml-1">
              <h2 className="text-black mb-5 2xl:mb-2 text-[16px] lg:text-[28px] xl:text-[36px] 2xl:text-[45px] font-normal">
                Our mantra
              </h2>
              <p className="mb-0 xl:mb-[14px] 2xl:mb-[14px] leading-tight sm:leading-4 xl:leading-[24px] 2xl:leading-[27px]  text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[24px] xl:w-[90%]">
              ...
              <p className="mb-0 xl:mb-[14px] 2xl:mb-[14px] leading-tight sm:leading-4 xl:leading-[24px] 2xl:leading-[27px]  text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[24px]">
                We believe that true solutions are not achieved through
                short-term fixes, and temporary measures should not be touted as
                sustainable or strategic. As a result, we are dedicated to
                providing reliable, independent advice, and innovative solutions
                that promote long term sustainability and strategic success for
                our clients.
              </p>
              <p className="mb-0 xl:mb-[14px] 2xl:mb-[14px] leading-tight sm:leading-4 xl:leading-[24px] 2xl:leading-[27px]  text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[24px] xl:w-[95%] 2xl:w-[94%]">
                ...
                innovate, collaborate towards positive change, and celebrate
                their uniqueness within our diverse teams.
              </p>
              <div className="actions mt-[30px] sm:mt-4">
                ...
                <Link href={"/contact-us"} className="mr-2 ml-4">
                  <CustomButton variant={"dark"} className="bg-transparent">
                    Contact Us
                  </CustomButton>
                </Link>
              </div>
        ...
        <section id="our-mission" className="div_section">
          <div
            id="our-purpose"
            className="maxw flex items-center gap-3  2xl:pb-20 2xl:pt-10"
          >
            <div className="content w-[60%] 2xl:ml-3">
              <h2 className="text-black mb-5 2xl:mb-[10px] text-[16px] lg:text-[28px] xl:text-[36px] 2xl:text-[45px] font-normal">
                Our mission
              </h2>
              <p className="mb-0 xl:mb-[14px] 2xl:mb-[14px] leading-tight sm:leading-4 xl:leading-[24px] 2xl:leading-[27px]  text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[24px]">
                To provide{" "}
                <strong className="tracking-wide">our clients</strong> with an
                unrivaled level of service excellence, empowering them to
                realize their full potential and achieve sustainable growth.
              </p>
              <p className="mb-0 xl:mb-[14px] 2xl:mb-[14px] leading-tight sm:leading-4 xl:leading-[24px] 2xl:leading-[27px]  text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[24px]">
                To create a workplace that empowers{" "}
                <strong className="tracking-wide">our people</strong> to lead
                healthy lives, drive innovation, influence outcomes, and
                celebrate their uniqueness within our diverse teams.
              </p>
              <h2 className="text-black my-5 2xl:mb-[10px] text-[16px] lg:text-[28px] xl:text-[36px] 2xl:text-[45px] font-normal">
                Our purpose
              </h2>
              <p className="mb-0 xl:mb-[14px] 2xl:mb-[14px] leading-tight sm:leading-4 xl:leading-[24px] 2xl:leading-[27px] 2xl:w-[640px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[24px]">
                Build trust and promote collaborations where people and
                societies can sustainably advance, create, and be remembered for
                their legacies.
              </p>
              <div className="actions mt-[30px] sm:mt-[16px] 2xl:mt-12">
