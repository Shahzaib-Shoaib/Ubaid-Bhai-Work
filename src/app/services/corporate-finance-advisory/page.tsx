...
const CorporateFinanceAdvisory: NextPage = () => {
  return (
    <main className="corporate-finance-advisory-page">
      ...
      {/* Banner */}
      <section className="banner div_section bg-[url('/images/corporate-finance-advisory-banner.jpg')] bg-center bg-cover relative flex items-center justify-center sm:p-0 w-full overflow-hidden  sm:h-[200px] xl:h-[500px] 2xl:h-[670px]">
      ...
      >
        <div className="maxw mx-auto flex flex-col items-center justify-center">
          <h2 className="section_heading py-1 w-fit text-center border-b border-b-golden font-normal">
            Our Corporate Finance Advisory services
          </h2>
          <div className="content my-7 sm:mt-4 xl:mt-14 2xl:mt-14  w-full">
            ...
            <Tabs defaultValue="valuation" className="w-full mt-4">
              ...
              >
                <p>
                We provide a factual perception that helps you to understand the value of your business. 
                </p>
                <p>
                Valuation is required in various situations including:
                </p>
                ...
                <p className='mt-4'>Our valuation services will be conducted in accordance with internationally recognized valuation methodologies, and will be executed by experienced professionals with comprehensive knowledge across a range of industries.</p>
                <p>Our team is committed to collaborating with all stakeholders, including directors, lawyers, and bankers, in order to achieve the best possible results.</p>
              </TabsContent>
              <TabsContent
                value="capital-structuring-restructuring"
                className="bg-white text-textgrey p-4"
              >
                <p>Each organization’s capital structure needs are distinct, and whether driven by strategic repositioning or financial distress, our expertise can assist clients in enhancing and restructuring their balance sheet to achieve an optimal capital structure and regain financial well-being.</p>
                <p>We can support on multiple fronts:</p>
                <ul className="points plist list-outside ml-4">
                  <li className="p mb-1">Optimize / deleverage balance sheet and provide maximum operational flexibility.</li>
                  <li className="p mb-1">Debt management advisory – Debt covenants advisory with lenders, bondholders, and other interest bearing debt instruments.</li>
                  <li className="p mb-1">Liquidity enhancement strategies and working capital assessments.</li>
                  <li className="p mb-1">Capital Raise Advisory (Debt or / and Equity).</li>
                </ul>
              </TabsContent>
              <TabsContent
                value="financial-modeling"
              ...
              >
                <p>
                Financial models play a vital role in business decision-making by projecting future financial performance and evaluating potential outcomes across various circumstances.
                </p>
                <p>
                Our flexible and adaptable financial models can provide you with valuable insights to support informed, accurate, and timely operational and strategic decision-making, and to formulate dependable forecasts based on different scenarios.
                </p>
                <p>MMP’s integrated financial models cover various areas, including (but not limited to) the following:</p>
                <ul className="points plist list-outside ml-4">
                  <li className="p mb-1">Budgeting and financial forecasts.</li>
                  <li className="p mb-1">Mergers and acquisitions.</li>
                  <li className="p mb-1">Investment and Capital budgeting decisions.</li>
                  <li className="p mb-1">Valuation and discounted cash flow models.</li>
                  <li className="p mb-1">Refinancing and equity raising analysis.</li>
                  <li className="p mb-1">Capital projects.</li>
                  <li className="p mb-1">Working capital analysis and budgeting.</li>
              ...
              >
                <p>
                Our M&A team firmly believes that a profound comprehension of deal participants’ objectives and expectations lays the foundation for a successful M&A transaction. We actively engage with our clients, working to crystallize transaction objectives, unearth synergies, and deliver tailored solutions that generate exceptional value.
                </p>
                <p>We provide our buy-side and sell-side advisory services to a broad spectrum of clientele, including large-scale corporations, small to mid-cap businesses, both publicly listed and privately held companies, startups, and family offices.</p>
                <ul className="points plist list-outside ml-4">
                  <li className="p m-0 text-black">Buy-side Financial Due Diligence</li>
                  <p className="sm:ml-3 sm:mt-2">MMP assists buyers in making informed and timely investment decisions by offering comprehensive analyses of the target’s financials. Our analysis identifies potential synergies and opportunities that can impact the value of the investment, enabling you to negotiate the right deal at the right terms and price.</p>
                  <li className="p m-0 text-black">Sell-side Financial Due Diligence</li>
                  <p className="sm:ml-3 sm:mt-2">As a seller, MMP will work with you to highlight and present your business’s key financial strengths to maximize the sale price and achieve the best value from the divestiture.</p>
                </ul>
              </TabsContent>
              <TabsContent
                value="startups-fundraising"
              ...
              >
                <p>
                We assist startups in raising capital, leveraging our extensive network of investors and our advisory expertise in structuring investment deals, including private placements and other fundraising opportunities.
                </p>
              ...
              >
                <p>
                MMP can support you throughout the transaction cycle on several fronts:
                </p>
                <ul className="points plist list-outside ml-4">
                  <li className="p mb-1">Providing valuation reports.</li>
                  <li className="p mb-1">Assisting with private placements memorandum / information memorandum.</li>
                  <li className="p mb-1">Developing investment teasers.</li>
                  <li className="p mb-1">Creating prospectuses.</li>
                  <li className="p mb-1">Drafting sale and purchase agreements (SPA).</li>
                  <li className="p mb-1">Preparing shareholders' agreements.</li>
                </ul>
              </TabsContent>
            </Tabs>
