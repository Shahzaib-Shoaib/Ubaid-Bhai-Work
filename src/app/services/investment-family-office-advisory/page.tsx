...
const InvestmentFamilyOfficeAdvisory = () => {
  return (
    <main className="investment-family-office-advisory-page">
      ...
      {/* Banner */}
      <section className="banner div_section bg-[url('/images/investment-banner.png')] bg-cover bg-center relative flex items-center justify-center sm:p-0 w-full overflow-hidden sm:h-[200px] xl:h-[500px] 2xl:h-[670px] ">
