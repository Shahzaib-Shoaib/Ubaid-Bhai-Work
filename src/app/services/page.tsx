    ...
    <>
      ...
      <main className="services-page">
        ...
        >
          <div className="maxw mx-auto ">
            ...
            <Tabs defaultValue="financial-services" className="w-full">
              <TabsList className="h-fit bg-transparent flex items-center justify-center gap-40 border-b-2 rounded-none mb-[50px]">
                <TabsTrigger
                  value="financial-services"
                  className="flex flex-col items-center justify-center text-black data-[state=active]:text-golden "
                >
                  <h2 className="heading font-normal sm:mb-0 text-[9px] md:text-[9px] lg:text-[20px] xl:text-[23px] 2xl:text-[35px] ">
                    Financial Services
                  </h2>
                </TabsTrigger>
                <TabsTrigger
                  ...
                  <div className="content my-auto sm:mb-4 w-[70%] lg:w-[85%] xl:w-[85%] 2xl:w-[55%] 2xl:ml-16 text-black ">
                    <Accordion type="single" collapsible>
                      <AccordionItem value="asset-wealth-management">
                        ...
                        <AccordionContent>
                          <ul className="points plist ">
                            <li className="text-textgrey leading-8 sm:mb-[5px] md:mb-[5px] mb-[14px] text-[10px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px]">
                              Mutual funds
                            </li>
                            <li className="text-textgrey leading-8 sm:mb-[5px] md:mb-[5px] mb-[14px] text-[10px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px]">
                              Pension funds
                            ...
                            <li className="text-textgrey leading-8 sm:mb-[5px] md:mb-[5px] mb-[14px] text-[10px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px]">
                              ...
                              wealth building, wealth governance, investments,
                      ...
                      <AccordionItem value="banking">
                        ...
                        <AccordionContent>
                          <ul className="points plist">
                            <li className="text-textgrey leading-6  sm:mb-[5px] md:mb-[5px] mb-[14px] text-[10px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px]">
                              Commercial banking
                            </li>
                            <li className="text-textgrey leading-6  sm:mb-[5px] md:mb-[5px] mb-[14px] text-[10px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px]">
                              Investment banking
                      ...
                      <AccordionItem
                        className="pointer-events-none down-arrow"
                        value="brokerage-and-investments"
                      >
                        <AccordionTrigger className="hover:no-underline">
                          <ul className="points accordionlist">
                            <li className="accordion mt-1 mb-0 ">
                      ...
                      <AccordionItem
                        className="pointer-events-none down-arrow"
                        value="crypto-exchanges-and-crypto-mining"
                      >
                        <AccordionTrigger className="hover:no-underline">
                          <ul className="points accordionlist">
                            <li className="accordion mt-1 mb-0 ">
        ...
        <section className="message-banner bg-[url('/images/message-banner.jpg')] bg-cover text-white p-4">
          <div className="content maxw mx-auto flex  items-center justify-center sm:h-[250px] lg:h-[350px] xl:h-[350px] 2xl:h-[340px]">
            <div className="w-fit 2xl:w-[85%] text-center">
              <blockquote className="text-white">
                <Image
                  ...
                  className=" w-[22px]"
                />
                <p className="text-white text-center mb-0 text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] tracking-wider ">
                  As we believe in the power of{" "}
                  <strong>entrepreneurship</strong>, we are industry agnostic
                  when it comes to working with and supporting{" "}
                  <strong>Startups</strong>. With our deep understanding of the
                  unique challenges faced by early-stage companies, we are
                  passionate about guiding entrepreneurs navigate those
                  challenges and turn their visions into successful realities.
                </p>
                <Image
                  alt="quote-close"
        ...
        <section id="our-services" className="div_section">
          <div className="maxw mx-auto ">
            <h2 className="section_heading text-center text-[16px] md:text-[28px] lg:text-[28px] xl:text-[36px] 2xl:text-[45px] ">
              Our Services
            </h2>
            <div className="flex flex-col items-center justify-center gap-8">
              ...
              <div className="Corporate-Finance-Advisory post w-full flex">
                ...
                <div className="content div_section  bg-pinkish max-h-[500px] w-[50%] flex flex-col justify-center sm:p-[10px] md:p-[15px] lg:p-[20px] xl:p-[30px] 2xl:p-[30px]">
                  ...
                  <p className="text-textgrey leading-tight text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px]">
                    We provide our clients with strategic, financial, and
                    tactical advice in connection with business valuations,
                    financial modeling, capital structuring, and executing
              ...
              <div className="tax post w-full flex">
                ...
                <div className="content div_section  bg-pinkish max-h-[500px] w-[50%] flex flex-col justify-center sm:p-[10px] md:p-[15px] lg:p-[20px] xl:p-[30px] 2xl:p-[30px]">
                  ...
                  <p className="text-textgrey leading-tight text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px]">
                    We help you navigate the evolving tax landscape in the UAE
                    and GCC and ensure compliance with the evolving regulations.
                  </p>
                  <p className="text-textgrey leading-tight text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px]">
              ...
              <div className="Risk-Regulatory-Advisory post w-full flex">
                ...
                <div className="content div_section  bg-pinkish max-h-[500px] w-[50%] flex flex-col justify-center sm:p-[10px] md:p-[15px] lg:p-[20px] xl:p-[30px] 2xl:p-[30px]">
                  ...
                  <p className="text-textgrey leading-tight text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px]">
                    ...
                    audit processes, and enhancing business resilience in
