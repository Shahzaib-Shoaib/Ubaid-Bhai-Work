...
const riskRegulatoryAdvisory = () => {
  return (
    <main className="risk-regulatory-advisory-page">
      ...
      {/* Banner */}
      <section className="banner div_section bg-[url('/images/risk-banner.png')] bg-cover bg-center relative flex items-center justify-center sm:p-0 w-full overflow-hidden sm:h-[200px] xl:h-[500px] 2xl:h-[670px]">
