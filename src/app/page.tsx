    ...
    <main className="home-page">
      ...
      <section id="advisory-expertise" className="div_section bggolden py-[30px]">
        <div className="maxw">
          ...
          <div className="expertise-tabs w-full mt-5 2xl:mt-7">
            <Tabs defaultValue="finance-accounting" className="sm:hidden w-full mt-4">
              ...
              <TabsContent className="mt-4" value="finance-accounting">
                <h2 className=" text-black font-medium mb-5 text-[16px] lg:text-[28px] xl:text-[36px] 2xl:text-[35px]">Finance & Accounting</h2>
              ...
              <TabsContent className="mt-4" value="tax">
                <h2 className="text-black mb-5 text-[16px] lg:text-[28px] xl:text-[36px] 2xl:text-[35px]">Tax</h2>
                <p className="text-textgrey mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] w-[94%]">
              ...
              <TabsContent className="mt-4" value="investment-family-office-advisory">
                <h2 className="text-black mb-5 text-[16px] lg:text-[28px] xl:text-[36px] 2xl:text-[35px]">
                  Investment & Family Office Advisory
                </h2>
                <p className="text-textgrey mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] w-[94%]">
            ...
            >
              <AccordionItem value="finance-accounting" className="mt-0 border-b-0">
                ...
                <AccordionContent className="p-0 pt-4">
                  ...
                  <Link href={"/services/finance-accounting/"}>
                    <CustomButton variant={"golden"} className="gap-1 py-2 px-5 text-[17px]">
                      Learn More
                      <Icons.arrowRight className="w-4 h-4 sm:w-2 sm:h-2" />
                    </CustomButton>
                  </Link>
              ...
              <AccordionItem value="corporate-finance-advisory" className="mt-0 border-b-0">
                <AccordionTrigger className="hover:no-underline py-2 border-b border-b-[#5D5D5D]  data-[state=open]:text-golden data-[state=open]:border-b-golden">
                  <div className="flex items-center justify-start gap-4">
                    <Image
                      alt="Finance and Accounting"
              ...
              <AccordionItem value="investment-family-office-advisory" className="mt-0 border-b-0">
                <AccordionTrigger className="hover:no-underline py-2 border-b border-b-[#5D5D5D]  data-[state=open]:text-golden data-[state=open]:border-b-golden">
                  <div className="flex items-center justify-start gap-4">
                    <Image
              ...
              <AccordionItem value="risk-regulatory-advisory" className="mt-0 border-b-0">
                <AccordionTrigger className="hover:no-underline py-2 border-b border-b-[#5D5D5D]  data-[state=open]:text-golden data-[state=open]:border-b-golden">
                  <div className="flex items-center justify-start gap-4">
                    <Image
              ...
              <AccordionItem value="management-consulting" className="mt-0 border-b-0">
                <AccordionTrigger className="hover:no-underline py-2 border-b border-b-[#5D5D5D]  data-[state=open]:text-golden data-[state=open]:border-b-golden">
                  <div className="flex items-center justify-start gap-4">
                    <Image
      ...
      <section className="div_section">
        <div className="maxw flex items-center gap-2 ">
          <div className="content w-[65%] ">
            <h2 className="border-b border-b-golden w-fit text-golden mb-5 text-[12px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] font-medium">Get to know us</h2>
            <h2 className="text-black mb-5 text-[16px] lg:text-[28px] xl:text-[36px] 2xl:text-[45px] font-medium">Progressive, Pragmatic, Switched on</h2>
            <p className=" mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] ">Our approach is collaborative, our philosophy is entrepreneurial.</p>
            <p className="mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] w-[90%] 2xl:w-[85%]">We take genuine interest in collaborating with you and understanding your business.</p>
            <p className="mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] w-[95%] xl:w-[90%] 2xl:w-[80%]">We bring diverse expertise and perspectives to gain a 360 view of your business and its macros.</p>
            <p className="mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] w-[90%] xl:w-[85%]">Our objective is to unveil opportunities and unlock innovative ideas that promote sustainable growth. </p>
      ...
      <section className="div_section bggolden">
        <div className="maxw flex items-center gap-4">
          ...
          <div className="content w-[60%] 2xl:ml-[60px] ">
            <h2 className="border-b border-b-golden w-fit text-golden mb-5 text-[12px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] font-medium">Why us</h2>
            <h2 className="text-black mb-5 text-[16px] lg:text-[28px] xl:text-[36px] 2xl:text-[45px] font-medium">Trusted, Independent, Experienced</h2>
            <p className="mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] w-[90%]">Our commitment to our clients is an unrivaled level of service excellence across the suite of our services.</p>
            <p className="mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px]">We pride ourselves with the trusted relationships and the borderless network that we have built over the years.</p>
            <p className="mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] w-[90%]">We prioritize building strong and trustworthy relationships with our clients, ensuring that their growth is at the forefront of our daily interactions.</p>
            <p className="mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] w-[90%]">At every interaction, we bring a depth of insight and foresight. We go beyond providing advisory solutions to existing problems, leveraging our experience to proactively maximize opportunities for sustainable growth.</p>
      ...
      <section className="div_section">
        <div className="maxw flex items-center gap-4">
          <div className="content w-[60%] ">
            <h2 className="border-b border-b-golden w-fit text-golden mb-5 text-[12px] lg:text-[18px] xl:text-[20px] 2xl:text-[22px] font-medium">Join our team</h2>
            <h2 className="text-black mb-5 text-[16px] lg:text-[28px] xl:text-[36px] 2xl:text-[45px] font-medium">Lead with character, Win together</h2>
            <p className="mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] xl:w-[90%]">At Morsi M Partners, we foster an inclusive environment that highly values diversity, equity, and inclusion.</p>
            <p className="mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] xl:w-[95%]">Our commitment is to create a workplace that empowers our people to lead healthy lives, drive innovation, influence outcomes, and celebrate their uniqueness within our diverse teams.</p>
            <p className="mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] xl:w-[95%]">Our team is a mosaic of people and perspectives which fuels our ability to provide innovative and creative solutions to our clients.</p>
            <p className="mb-[14px] text-[10px] md:text-[16px] lg:text-[16px] xl:text-[18px] 2xl:text-[20px] xl:w-[95%]">We are committed to actively recruiting, supporting, and developing individuals from all backgrounds. </p>
            <div className="actions">
              <Link href={"/careers"}>
          ...
          <div className="image w-[40%] sm:flex sm:items-center sm:justify-center  xl:flex xl:items-center xl:justify-end 2xl:flex 2xl:items-center 2xl:justify-end">
            <img
              alt="Get to know us image"
